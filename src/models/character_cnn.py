...
from src.character_idx import CharacterMapper, CharacterIndexer
...
class CharacterCNN(torch.nn.Module):
    ...
    def forward(self, inputs: torch.Tensor) -> Dict[str, torch.Tensor]:
        ...
        for i in range(len(self._convolutions)):
            conv = getattr(self, "char_conv_{}".format(i)).cuda()
        ...
        return token_embedding.view(batch_size, sequence_length, -1).cuda()
